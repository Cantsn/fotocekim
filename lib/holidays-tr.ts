/** Türkiye resmi tatilleri + bilinen özel günler
 *  NOT: Sistem otomatik randevu KAPATMAZ — sadece müşteriye bildirir.
 *  Kapama kararı admin “Özel gün” / “Gün kapat” ayarındadır.
 */
...
export type HolidayInfo = {
  ...
  /** Sistem tatilleri her zaman false — bilgilendirme amaçlı */
...
export function getTurkeyHolidays(year: number): HolidayInfo[] {
  const list: HolidayInfo[] = [
    { date: ymd(year, 1, 1), title: "Yılbaşı", type: "HOLIDAY", blockBooking: false },
    {
      date: ymd(year, 4, 23),
    ...
    {
      date: ymd(year, 3, 18),
      title: "Çanakkale Zaferi ve Şehitleri Anma",
      type: "SPECIAL",
      blockBooking: false,
    },
    {
